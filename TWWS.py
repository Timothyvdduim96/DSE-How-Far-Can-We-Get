...
c = value("c")
rho_0 = value("rho_0")
V_land = 80.#sqrt(value("s_l")/0.5835)
f = value("f")
n_max = value("n_max")
...
g = value("g")
FL = value("FL")
V_max = max_speed(FL_to_m)
MTOW = value("MTOW")#eval(designdata[16][3])
...
z=[[6251.5,0.358]]
plt.plot(*zip(*z), marker='o', markersize=8, color='fuchsia')#, label="A320neo") #A320neo
h=[[6819.4,0.326]]
