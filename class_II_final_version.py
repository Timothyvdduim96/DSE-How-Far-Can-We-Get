...
pi             = np.pi               #pi
d_ext_fus      = 3.8*mft             #fuselage diameter
l_fus          = 44.85*mft           #fuselage length
ratio_nosecone = 1.5                 #fineness ratio nosecone
ratio_tailcone = 3.7                 #fineness ratio tailcone
...
w_cargo = 1.6*mft   # width of cargo hold floor   
...
# Avionics group
W_empty = 38369.82*kglbs #empty weight
