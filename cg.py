...
for i in range(2):
    ...
    def hortail():
        ...
        w = value("W_empennage")/kglbs/4 #CHANGE
        mom = x_cg*w
    ...
    def verttail():
        ...
        w = value("W_empennage")/kglbs/4*3 #CHANGE
        mom = x_cg*w
    ...
    def engines():
        ...
        w = value("W_propulsion")/kglbs #ADD
        mom = x_cg*w
    ...
    def mainlandinggear():
        ...
        w = value("W_landinggear")/kglbs/10.*9. #CHANGE
        mom = x_cg*w

        return x_cg,w,mom

    def noselandinggear():
        w = value("W_landinggear")/kglbs/10. #CHANGE
